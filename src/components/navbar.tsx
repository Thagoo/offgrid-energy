...
export default function Navbar() {
  ...
  return (
    <>
      {" "}
      <div className="px-4 md:px-4 py-1 md:py-2 flex justify-between items-center rounded-full shadow-xl fixed gap-8 z-50 backdrop-blur-md backdrop-filter bg-opacity-20 blur-safari">
